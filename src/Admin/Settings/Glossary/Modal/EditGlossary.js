                                          ...
                                          <div className="card-body">
                                            <form className="" method="POST" action="" id="regform" name="regform" enctype="multipart/form-data">
                                              <div className="form-group">
                                                <div className="form-row">
                                                  <div className="col-md-12 mb-15 pr-50">
                                                      ...
                                                      <input type="text" className="form-control" id="tname" name="tname" placeholder="" readonly/>
                                                  </div>
                                                </div>
                                              </div>
                                              <div className="form-group">
                                                <div className="form-row">
                                                  <div className="col-md-12 mb-15 pl-50">
                                                      ...
                                                      <textarea rows="3" type="text" className="form-control" name="tdesc" id="tdesc" placeholder="" readonly></textarea>
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div className="d-flex">
                                                <button type="submit" className="btn btn-primary mybtn" id="btnreg" name="btnreg"><i className="fas fa-fw fa-file"></i> Edit Term</button>
                                              </div>
