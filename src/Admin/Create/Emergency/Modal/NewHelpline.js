                  ...
                  <div className="form-group">
                    <div className="form-row">
                      <div className="col-md-12 mb-15 pl-50">
                        ...
                        <input type="text" className="form-control" id="phone" name="phone" value={this.state.phone} onChange={this.handleChange} placeholder="" required />
                      </div>
                    </div>
                  </div>
                  <div className="form-group">
                    <div className="form-row">
                      <div className="col-md-12 mb-15 pl-50">
                        ...
                        <input type="text" className="form-control" id="ussd" name="ussd" value={this.state.ussd} onChange={this.handleChange} placeholder="" required />
                      </div>
                    </div>
                  </div>
