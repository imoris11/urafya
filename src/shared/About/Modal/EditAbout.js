                    ...
                    <div className="form-group">
                      <div className="form-row">
                        <div className="col-md-12 mb-15 pr-50">
                            ...
                            <textarea rows="3" type="text" className="form-control" name="adesc" id="adesc" placeholder="" required></textarea>
                        </div>
                      </div>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      <div className="form-row">
                        <div className="col-md-12 mb-15 pl-50">
                            ...
                            <textarea rows="3" type="text" className="form-control" name="ahelp" id="ahelp" placeholder="" required></textarea>
                        </div>
                      </div>
                    </div>
