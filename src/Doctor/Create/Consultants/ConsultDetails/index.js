                ...
                <Tabs>
                  ...
                  <TabPanel>
                    ...
                    >
                      <br></br>
                      <p>
                        <b className="text-primary">Patient Test Result</b>
                      </p>
                      <img src="" />
                      <hr />
                      <p>
                        <b className="text-primary">Doctor's Feedback:</b> Et et
                        consectetur ipsum labore excepteur est proident
                        excepteur ad velit occaecat qui minim occaecat veniam.
                        Fugiat veniam incididunt anim aliqua enim pariatur
                        veniam sunt est aute sit dolor anim. Velit non irure
                        adipisicing aliqua ullamco irure incididunt irure non
                  ...
                  <TabPanel>
                    ...
                    >
                      <br></br>
                      <p>
                        <b className="text-primary">Test Result Status:</b>{" "}
                        Found
                      </p>
                      <p>
                      ...
                      <p>
                        <b className="text-primary">Disease Type:</b> Type B
                      </p>
                      <p>
                        <b className="text-primary">Disease Description:</b> Et
                        et consectetur ipsum labore excepteur est proident
                        excepteur ad velit occaecat qui minim occaecat veniam.
                        Fugiat veniam incididunt anim aliqua enim pariatur
                        veniam sunt est aute sit dolor anim. Velit non irure
                        adipisicing aliqua ullamco irure incididunt irure non
                      ...
                      <p>
                        <b className="text-primary">Doctor's Advice:</b> Et et
                        consectetur ipsum labore excepteur est proident
                        excepteur ad velit occaecat qui minim occaecat veniam.
                        Fugiat veniam incididunt anim aliqua enim pariatur
                        veniam sunt est aute sit dolor anim. Velit non irure
                  ...
                  <TabPanel>
                    ...
                    >
                      <br></br>
                      <p>
                        <b className="text-primary">General Recommendation:</b>{" "}
                        Et et consectetur ipsum labore excepteur est proident
                        excepteur ad velit occaecat qui minim occaecat veniam.
                        Fugiat veniam incididunt anim aliqua enim pariatur
                        veniam sunt est aute sit dolor anim. Velit non irure
                      ...
                      <p>
                        <b className="text-primary">Recommended Groceries:</b>{" "}
